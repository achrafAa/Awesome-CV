...
\address{Morocco, World Wide (Remote)}

\mobile{(+212) 700-700-730}
\email{achraf.aamri@gmail.com}
%\dateofbirth{January 1st, 1970}
\homepage{achrafaamri.com}
\github{achrafAa}
\linkedin{achrafaamri}
% \gitlab{gitlab-id}
...
\quote{``Dedicated to building robust, maintainable, and high-performance software through TDD, DDD, and EDD, ensuring scalability, reliability, and long-term efficiency."}
